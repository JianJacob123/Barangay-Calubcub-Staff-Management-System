...
<meta charset="UTF-8">
    ...
    <body>
        ...
        <section class="main">
            ...
            <a href="addmember.php"><button class="nxtbtn" value="add-user"> + Add User</button></a>
            </div>
            ...
            <section class="sub">
                <div class="sub-bottom">
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        <td>
                        <a href="updatemember.php?updateid='.$row['member_id'].'"><button>Update</button></a>
                        <a href="deletemember.php?deleteid='.$row['member_id'].'"><button>Delete</button></a>
                        </td>
                        </tr>
                        </tbody>';
                        }
